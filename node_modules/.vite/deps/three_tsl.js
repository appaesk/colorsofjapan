    ...
    if (shadowMapType === VSMShadowMap) {
      ...
      if (shadowMap.isRenderTargetArray) {
        if (!shadowMap._vsmShadowMapVertical) {
          shadowMap._vsmShadowMapVertical = builder.createRenderTargetArray(shadow3.mapSize.width, shadow3.mapSize.height, shadowMap.depth, { format: RGFormat, type: HalfFloatType, depthBuffer: false });
        ...
        if (!shadowMap._vsmShadowMapHorizontal) {
          shadowMap._vsmShadowMapHorizontal = builder.createRenderTargetArray(shadow3.mapSize.width, shadow3.mapSize.height, shadowMap.depth, { format: RGFormat, type: HalfFloatType, depthBuffer: false });
